        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
              <div class="icon-stat">
                <div class="row">
                  <div class="col-xs-8 text-left">
                    <span class="icon-stat-label">Total Apporove Request</span>
            ...
            <div class="col-md-3 col-sm-6">
              <div class="icon-stat">
                <div class="row">
                  <div class="col-xs-8 text-left">
                    <span class="icon-stat-label">Total Complete Request</span>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="icon-stat">
                  <div class="row">
                    <div class="col-xs-8 text-left">
                      <span class="icon-stat-label">Total Declined Request</span>
