            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="{{route('admin.allevent')}}" class="btn btn-success pull-right">All Event</a>
                        </div>
                    </div>
                </div>
                <div class="panel-body">
                    ...
                    @endif
                    <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent = "editevent">
